...
@Component({
  selector: 'app-pointsbet',
  templateUrl: './pointsbet.component.html',
  styleUrls: ['./pointsbet.component.css']
})
export class PointsbetComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.seoService.updateTitle('PointsBet Review | Sportsbook for Points Betting | The Quant Edge');
  }
