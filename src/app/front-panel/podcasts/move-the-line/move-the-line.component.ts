...
@Component({
  selector: 'app-move-the-line',
  templateUrl: './move-the-line.component.html',
  styleUrls: ['./move-the-line.component.css']
})
export class MoveTheLineComponent implements OnInit, OnDestroy {
  podcastData: any = [];
  ...
  ngOnInit() {
    this.podcast_subscription = this.dataService.get_all_podcasts(13,4,this.bettingOffset, this.router.url).subscribe(
      (res:any) => {
  ...
  loadMore() {
    ...
    this.podcast_subscription = this.dataService.get_all_podcasts(13,4,this.bettingOffset).subscribe(
      (res:any) => {
