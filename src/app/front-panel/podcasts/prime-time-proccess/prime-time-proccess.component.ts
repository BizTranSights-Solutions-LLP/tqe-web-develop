...
@Component({
  selector: 'app-prime-time-proccess',
  templateUrl: './prime-time-proccess.component.html',
  styleUrls: ['./prime-time-proccess.component.css']
})
export class PrimeTimeProccessComponent implements OnInit, OnDestroy {
  podcastData: any = [];
  ...
  ngOnInit() {
    this.podcast_subscription = this.dataService.get_all_podcasts(17,4,this.bettingOffset, this.router.url).subscribe(
      (res:any) => {
  ...
  loadMore() {
    ...
    this.podcast_subscription = this.dataService.get_all_podcasts(17,4,this.bettingOffset).subscribe(
      (res:any) => {
