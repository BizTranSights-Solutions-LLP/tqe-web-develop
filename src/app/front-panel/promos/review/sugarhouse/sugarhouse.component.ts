...
@Component({
  selector: 'app-sugarhouse',
  templateUrl: './sugarhouse.component.html',
  styleUrls: ['./sugarhouse.component.css']
})
export class SugarhouseComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.seoService.updateTitle('Review of Sugarhouse | Sportsbook Reviews | The Quant Edge');
  }
