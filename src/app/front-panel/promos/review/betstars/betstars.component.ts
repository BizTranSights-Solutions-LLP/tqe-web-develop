...
@Component({
  selector: 'app-betstars',
  templateUrl: './betstars.component.html',
  styleUrls: ['./betstars.component.css']
})
export class BetstarsComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.seoService.updateTitle('Review of BetStars | Sportsbook Reviews | The Quant Edge');
  }
