...
@Component({
  ...
  templateUrl: './if-ncaaf.component.html',
  styleUrls: ['./if-ncaaf.component.scss']
})
export class IfNcaafComponent implements OnInit {
  ...
  private getData() {
    ...
    this.plumber.getIfcfTable().subscribe(
      win => {
        for (let i in win) {
