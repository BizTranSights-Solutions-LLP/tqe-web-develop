...
@Component({
  ...
  selector: 'tqe-cb-best-bets',
  templateUrl: './cb-best-bets.component.html',
  styleUrls: ['./cb-best-bets.component.scss'],
  encapsulation: ViewEncapsulation.Emulated
})

export class CbBestBetsComponent implements OnInit {

  isMobile: boolean = false;
  game_logo: string = `../../../../assets/images/home_page/ncaab_logo.svg`;
  game_background_img: string = `../../../../assets/images/picks/NCAAB_Picks_bg.png`;
  game_background_mobile_img: string = `../../../../assets/images/picks/NCAAB_Picks_bg.png`;
  ...
  private getData() {
    ...
    if (localStorage.getItem('data')) {
      ...
      this.plumber.getcbTablePublic().subscribe(
        this.processGames
      );
    }
  }
