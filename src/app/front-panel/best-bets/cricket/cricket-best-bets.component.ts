...
@Component({
  selector: 'tqe-cricket-best-bets',
  templateUrl: './cricket-best-bets.component.html',
  styleUrls: ['./cricket-best-bets.component.scss'],
  encapsulation: ViewEncapsulation.Emulated
})

export class CricketBestBetsComponent implements OnInit {

  isMobile: boolean = false;
  game_logo: string = `../../../../assets/images/home_page/cricket_logo.svg`;
  game_background_img: string = `../../../../assets/images/picks/Cricket_Picks_bg.png`;
  game_background_mobile_img: string = `../../../../assets/images/picks/Cricket_Picks_bg.png`;
  constructor(
  ...
  private processGames = win => {
    ...
    this.games.forEach(g => {
      ...
      g.home_team = g.home_team_first_name + (g.home_team_last_name ? ' ' + g.home_team_last_name : '');
      g.away_team = g.away_team_first_name + (g.away_team_last_name ? ' ' + g.away_team_last_name : '');
      g.home_team_logo = `../../../../assets/cricket/teams/${g.home_team}.png`;
      g.away_team_logo = `../../../../assets/cricket/teams/${g.away_team}.png`;
  ...
  private getData() {
    ...
    if (localStorage.getItem('data')) {
      this.plumber.getCricketTable(this.selected_league).subscribe(
        this.processGames
      );
    } else {
      this.plumber.getCricketTable(this.selected_league).subscribe(
