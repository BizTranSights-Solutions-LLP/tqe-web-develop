...
export class CfBestBetsComponent implements OnInit {
  ...
  game_logo: string = `../../../../assets/images/home_page/ncaaf_logo.svg`;
  game_background_img: string = `../../../../assets/images/picks/NCAAF_Picks_bg.png`;
  game_background_mobile_img: string = `../../../../assets/images/picks/NCAAF_Picks_bg.png`;
  constructor(
  ...
  private processGames =  win => {
    ...
    this.games.forEach(g => {
      ...
      g.away_team_logo = `../../../../assets/images/logos/cf/${g.away_team_full_name}.png`;
      g.home_team_logo = `../../../../assets/images/logos/cf/${g.home_team_full_name}.png`;
    });
    this.loading = false;
  };
