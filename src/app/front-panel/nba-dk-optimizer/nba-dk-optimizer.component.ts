...
// import { NbaDkService } from '../../services/nba-dk.service';
// import { AngularBootstrapToastsService } from 'angular-bootstrap-toasts';
// import { ModalDirective } from 'ngx-bootstrap/modal';
// import { NbaDkPlayerPoolComponent } from './player-pool/player-pool.component';
...
//
// @Component({
//   selector: 'app-nba-dk-optimizer',
//   templateUrl: './nba-dk-optimizer.component.html',
//   styleUrls: ['./nba-dk-optimizer.component.scss'],
//   encapsulation: ViewEncapsulation.None
// })
// @ViewChild(NbaDkPlayerPoolComponent)
// @ViewChild(TeamFilterComponent)
//
// export class NbaDkOptimizerComponent implements OnInit {
//   @ViewChild('signupModal') signupModal: ModalDirective;
//   constructor(
//     private authService: AuthService,
//     private dataService: DataService,
//     private router: Router,
//     private plumber: NbaDkService,
//     private toast: AngularBootstrapToastsService
//   ) { }
//
//   storageKey: string  = "tqe-nba-dk-optimizer";
...
//
//   rosterPositions: any = ["PG","SG","SF","PF","C","G","F","UTIL"];
//
//   slate: any = {};
//
//   ngOnInit() {
...
//             },
//             toCsv: function () {
//               let csvName = "Lineups_" + this.slateName + "_" + moment().format("YYYYMMDD");
...
//               })
//               new ngxCsv(body, csvName, {headers: ["PG","SG","SF","PF","C","G","F","UTIL"]});
//             },
...
//             let playerId  = parseInt(rawPlayer.player.match(/\((\d+)\)/)[1]);
//             let lineupPos = rawPlayer.pos1;
...
//     // Reset
//     this.slate.myLineups      = [];
//     this.slate.lineupSummary  = { "PG": [], "SG": [], "SF": [], "PF": [], "C": [], "G": [], "F": [], "UTIL": [] };
...
//           for (var i = 0; i < players.length; i++) {
//             let player    = players[i];
//             let playerId  = parseInt(player.player.match(/\((\d+)\)/)[1]);
//
//             player.id             = playerId;
...
//               this.slate.myLineups[player.lineup_num].roster[player.pos1] = player;
//             } else {
...
//     let key           = e.playerId;
//     let player        = this.slate.playerDict[key];
//     let primary_pos   = player.selectedpos;
//     let secondary_pos = primary_pos.match(/[GF]/) ? primary_pos.match(/[GF]/)[0] : "UTIL";
//     let util_pos      = "UTIL";
//
//     if (player.locked) {
...
//     }
//
//     if (!this.slate.optimalLineup[primary_pos] || !this.slate.optimalLineup[primary_pos].locked) {
//       player.locked     = true;
//       player.optimized  = true;
//       player.excluded   = false;
//       player.lineup_pos = primary_pos;
//       this.slate.optimalLineup[primary_pos] = player;
//       this.slate.optimalLineupStats();
//     } else if (!this.slate.optimalLineup[secondary_pos] || !this.slate.optimalLineup[secondary_pos].locked) {
//       player.locked     = true;
//       player.optimized  = true;
//       player.excluded   = false;
//       player.lineup_pos = secondary_pos;
//       this.slate.optimalLineup[secondary_pos] = player;
//       this.slate.optimalLineupStats();
//     } else if (!this.slate.optimalLineup[util_pos] || !this.slate.optimalLineup[util_pos].locked) {
//       player.locked     = true;
//       player.optimized  = true;
//       player.excluded   = false;
//       player.lineup_pos = util_pos;
//       this.slate.optimalLineup[util_pos] = player;
//       this.slate.optimalLineupStats();
//     } else {
//       this.toastErrorMsg("Can't Lock Player", `The <b>${primary_pos}</b>${secondary_pos === util_pos ? ' ' : (', <b>' + secondary_pos + '</b>, ')} and <b>${util_pos}</b> positions are already locked. Remove a player from one of these positions to add <b>${player.name}</b>`);
//       return false;
//     }
//   }
//
...
//       errorFound = true;
//     } else if (this.slate.lineup_options.cap_max > 50000) {
