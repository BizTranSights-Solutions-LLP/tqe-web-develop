...
@Component({
  selector: 'app-caesers',
  templateUrl: './caesers.component.html',
  styleUrls: ['./caesers.component.css']
})
export class CaesersComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.seoService.updateTitle('Review of Caesers | Sports Betting | Caesars Review | The Quant Edge');
  }
