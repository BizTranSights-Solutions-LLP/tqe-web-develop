...
@Component({
  ...
  selector: 'tqe-mlb-best-bets',
  templateUrl: './mlb-best-bets.component.html',
  styleUrls: ['./mlb-best-bets.component.scss'],
  encapsulation: ViewEncapsulation.Emulated
})

export class MlbBestBetsComponent implements OnInit {

  isMobile: boolean = false;
  game_logo: string = `../../../../assets/images/home_page/baseball_logo.svg`;
  game_background_img: string = `../../../../assets/images/picks/MLB_Picks_bg.png`;
  game_background_mobile_img: string = `../../../../assets/images/picks/MLB_Picks_bg.png`;
  constructor(
  ...
  private getData() {
    ...
    if (localStorage.getItem('data')) {
      this.plumber.getMlbTable().subscribe(
        this.processGames
      );
    } else {
      this.plumber.getMlbTablePublic().subscribe(
        this.processGames
      );
    }
  }
