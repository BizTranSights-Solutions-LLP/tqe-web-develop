...
@Component({
  ...
  styleUrls: ['./thrive.component.css']
})
export class ThriveComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.seoService.updateTitle('Review of Thrive | Sportsbook Reviews | The Quant Edge');
  }
